...
export default function VideoPopularSide({ CategoryName, catslug }) {
    const [videos, setVideos] = useState([])

    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}webtv-category-video-popular/${catslug}/5`)
            .then(({ data }) => {
                setVideos(data.categoryWisePopularVideo);
