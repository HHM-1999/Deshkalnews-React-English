...
export default function FactCheck() {
    ...
    try {
        useEffect(() => {
            axios
                .get(`${process.env.REACT_APP_EN_API_URL}home-json-en/generateCategory46.json `)
                .then(({ data }) => {
                    if (data.length > 0) {
                        setList1(data[0]);
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="section-heading">
                                <h2><i className="fa-solid fa-chevron-right"></i><Link to="/fact-check" onClick={scrollTop}>Fact Check</Link></h2>
                            </div>
                        </div>
                    </div>
