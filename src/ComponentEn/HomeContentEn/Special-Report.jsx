...
export default function SpecialReport() {
    ...
    try {
        useEffect(() => {
            axios
                .get(`${process.env.REACT_APP_EN_API_URL}home-json-en/generateCategory32.json`)
                .then(({ data }) => {
                    if (data.length > 0) {
                        setList1(data[0]);
        ...
        return (
            <>
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading">
                            <h2><Link to='/special-report' onClick={scrollTop}><i className="fa-solid fa-chevron-right"></i>Special Report</Link></h2>
                        </div>
                    </div>
                </div>
                ...
                <div className="seeMore">
                    <Link className="btn btnMore" to="/special-report" onClick={scrollTop}>More...</Link>
                </div>
            </>
        )
    }
