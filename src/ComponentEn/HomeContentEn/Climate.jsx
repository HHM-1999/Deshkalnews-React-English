            ...
            <>
                <div className="job-area-news">
                    <div className="row">
                        <div className="col-12">
                            <div className="section-heading">
                                <h2><i className="fa-solid fa-chevron-right"></i><Link to='/climate' onClick={scrollTop}>Climate</Link></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="seeMore">
                        <Link className="btn btnMore" to="/climate" onClick={scrollTop}>More...</Link>
                    </div>
                </div>
            </>
        )
